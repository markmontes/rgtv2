    ...
    $(document).ready(function(){
        ...
        $('#generateReport').click(function(){
            ...
            sData.forEach(function(item) {
                if(item=="toc" || item=="tac" || item=="pagebreak" || item=="header" || item=="content" || item=="numbering" || item=="definition" || item=="bar" ||item=="line" ||item=="textbold" ||item=="donut" || item=="well" || item=="horbar" || item=="table" || item=="progress" || item=="colorwell" || item=="donuthead" || item=="donut2" || item=="end"){
                    totCont++;
                }
            });
                                        ...
                                        onrendered: function (canvas) {
                                            imgData3 = canvas.toDataURL("image/jpeg", 2.0);
                                             ...
                                             $.ajax({
                                                ...
                                                url: '/reports/addrow',
                                                async: true,
                                                data: {id: reportId, text: text, data1: dispVal1, imgData1: imgData1, data2: dispVal2, imgData2: imgData2, data3: dispVal3, imgData3: imgData3, saveType: 'donut2'},
                                                success: function(result){
                                                    console.log("donut2");
                                                }
                                            });
